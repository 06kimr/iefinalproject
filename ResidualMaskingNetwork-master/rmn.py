...
if checkbox_btn1: 
    ...
    localimage = cv2.imread('ResidualMaskingNetwork-master\\1.jpg')
    localimage2 = cv2.imread('ResidualMaskingNetwork-master\\2.jpg')
    localimage3 = cv2.imread('ResidualMaskingNetwork-master\\3.jpg')
